...
public class L4_BuildingController : MonoBehaviour {
    ...
    /***********************************************************************************
    * Function Name: Spawn_L4
    * Description: Spawn a L4 tower at the selected space
    **********************************************************************************/
    public void Spawn_L4(Space space)
    {
        // Build L4 Tower on space
        _L4_Full_Tower = Instantiate(L4_Full_TowerPrefab) as GameObject;
        _L4_Full_Tower.transform.position = space.spacePosition;
        space.building = _L4_Full_Tower;
    }
