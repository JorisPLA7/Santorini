...
public class L3_BuildingController : MonoBehaviour {
    ...
    /***********************************************************************************
    * Function Name: Spawn_L3
    * Description: Spawn a L3 tower at the selected space
    **********************************************************************************/
    public void Spawn_L3(Space space)
    {
        // Build L3 Tower on space
        _L3_Tower = Instantiate(L3_TowerPrefab) as GameObject;
        _L3_Tower.transform.position = space.spacePosition;
        space.building = _L3_Tower;
    }
