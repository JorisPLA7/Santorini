...
public class L2_BuildingController : MonoBehaviour {
    ...
    /***********************************************************************************
    * Function Name: Spawn_L2
    * Description: Spawn a L2 tower at the selected space
    **********************************************************************************/
    public void Spawn_L2(Space space)
    {
        // Build L2 Tower on space
        _L2_Tower = Instantiate(L2_TowerPrefab) as GameObject;
        _L2_Tower.transform.position = space.spacePosition;
        space.building = _L2_Tower;
    }
